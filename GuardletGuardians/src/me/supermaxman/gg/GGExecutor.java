        ...
        if(player.isOp()){
        	if(args.length>=1) {
        		...
        		if(s.equalsIgnoreCase("setlobby")) {
                	...
                	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Lobby now set at current location.");
        		}else if(s.equalsIgnoreCase("endgame")) {
        			GuardletGuardians.game.getThread().endGame();
                	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Game restarted.");
        			...
        			GuardletGuardians.plugin.saveConfig();
                	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Game now set at current location.");
        			...
        			try {
            			...
            			GuardletGuardians.plugin.saveConfig();
                    	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Snowball timer changed to "+ ChatColor.GOLD+t+ChatColor.AQUA+".");
        			}catch(Exception e) {
                    	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: Command used incorrectly, please only set numbers for time.");
        			}
        			...
        			try {
            			...
            			GuardletGuardians.plugin.saveConfig();
                    	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Sugar timer changed to "+ ChatColor.GOLD+t+ChatColor.AQUA+".");
        			}catch(Exception e) {
                    	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: Command used incorrectly, please only set numbers for time.");
        			}
        			...
        			try {
            			...
            			GuardletGuardians.plugin.saveConfig();
                    	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Start time changed to "+ ChatColor.GOLD+t+ChatColor.AQUA+".");
        			}catch(Exception e) {
                    	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: Command used incorrectly, please only set numbers for time.");
        			}
        			...
        			try {
            			...
            			GuardletGuardians.plugin.saveConfig();
                    	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Finish laps changed to "+ ChatColor.GOLD+t+ChatColor.AQUA+".");
        			}catch(Exception e) {
                    	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: Command used incorrectly, please only set numbers for time.");
        			}
        			...
        			try {
            			...
            			GuardletGuardians.plugin.saveConfig();
                    	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Finish id 1 changed to "+ ChatColor.GOLD+t+ChatColor.AQUA+".");
        			}catch(Exception e) {
                    	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: Command used incorrectly, please only set numbers for ids.");
        			}
        			...
        			try {
            			...
            			GuardletGuardians.plugin.saveConfig();
                    	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Finish id 2 changed to "+ ChatColor.GOLD+t+ChatColor.AQUA+".");
        			}catch(Exception e) {
                    	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: Command used incorrectly, please only set numbers for ids.");
        			}
        			...
        			try {
            			...
            			GuardletGuardians.plugin.saveConfig();
                    	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Guardian id changed to "+ ChatColor.GOLD+t+ChatColor.AQUA+".");
        			}catch(Exception e) {
                    	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: Command used incorrectly, please only set numbers for ids.");
        			}
        			...
        			try {
            			...
            			GuardletGuardians.plugin.saveConfig();
                    	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Minimum player limit changed to "+ ChatColor.GOLD+t+ChatColor.AQUA+".");
        			}catch(Exception e) {
                    	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: Command used incorrectly, please only set numbers for limits.");
        			}
        			...
        			try {
            			...
            			GuardletGuardians.plugin.saveConfig();
                    	player.sendMessage(ChatColor.AQUA+"[GuardletGuardians]: Maximum player limit changed to "+ ChatColor.GOLD+t+ChatColor.AQUA+".");
        			}catch(Exception e) {
                    	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: Command used incorrectly, please only set numbers for limits.");
        			}
        		}else {
                	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: Command used incorrectly, use /hvd setlobby,runnerpoint,endgame,starttime [time],timelimit [time],appletimer [time], minplayers [limit],maxplayers [limit].");
        		}
        	}else {
            	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: Command used incorrectly, use /hvd setlobby,setgame,setapple,endgame,starttime [time],timelimit [time],appletimer [time], minplayers [limit],maxplayers [limit].");
        	}
        }else {
        	player.sendMessage(ChatColor.RED+"[GuardletGuardians]: You do not have permission to use this command.");
        }
    }
